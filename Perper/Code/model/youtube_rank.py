...
class Youtube_Rank:
    def __init__(self):
        super(Youtube_Rank,self).__init__()
...
#        data_df.groupby('userId').sort_values(by=['timestamp'])
   ...
   #     with mirrored_strategy.scope():
        self.model = youtube_rank_model(self.userid_max,self.movieid_max,global_args.hist_len)
        self.model.summary()
        # ======== model checkpoint === 
